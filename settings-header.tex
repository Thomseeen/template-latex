...
\usepackage[hyphens]{url}					% Lade URL Package mit explizitem Umbruch bei "-" und fuer \path
\usepackage{booktabs}						% Fuer Tabellen von tablesgenerator.com
\usepackage{graphicx}						% Fuer Tabellen von tablesgenerator.com
\usepackage[table,xcdraw]{xcolor}			% Fuer Tabellen von tablesgenerator.com
\usepackage[binary-units=true]{siunitx}		% Huebsche Einheiten
\sisetup{locale = DE}						% Huebsche Einheiten
